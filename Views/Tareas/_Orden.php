            ...
            <div id="formato-orden-trabajo" class="p-4 border">
                ...
                <div class="row mb-4">
                    <div class="mb-3">
                        ...
                        <div class="border-bottom pb-1" id="orden-inicio">10/06/2023 08:00</div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-sm mb-0">
                            ...
                            <tbody id="tareas-lista">
                                <tr>
                                    ...
                                    <td id="orden-materiales">Varillas de acero (5), Soldadura (2kg), Tornillos (20)</td>
                                    <td id="orden-tiempo">4 horas</td>
                                    
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Instalación de soportes para nueva maquinaria</td>
                                    <td>Perfiles metálicos (3), Anclajes (8)</td>
                                    <td>3 horas</td>

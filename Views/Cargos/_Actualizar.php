...
<div class="modal-content">
        ...
        <div class="modal-body">
            <form action=" <?= LOCAL_DIR ?>/Cargos/registrar" method="post" id="form-cargo" onsubmit="return false">
                <input type="hidden" name="form-id" value="<?= $cargo->id ?>">
                <div class="row">
                    <div class="col">
                        <label for="form-nombre" class="form-label">Nombre</label>
                        <input value="<?= $cargo->get_nombre() ?>" required maxlength="80" type="text" class="form-control" id="form-nombre" name="form-nombre-cargo" data-formText="form-text-form-nombre">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input value="<?= $cargo->get_nivel() ?>" required type="number" step="1" min="1" class="form-control" id="form-nivel" name="form-nivel-cargo" data-formText="form-text-form-nivel">
        ...
        <div class="modal-footer">
            <div class="d-flex justify-content-between gap-3">
                ...
                <button type="submit" form="form-cargo" class="btn btn-primary">Modificar</button>
            </div>
        </div>
    </div>
</div>
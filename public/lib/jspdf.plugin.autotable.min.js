        ...
        var e = {
            ...
            259: function(t, e, n) {
                ...
                e.parseCss = function(t, e, n, i, l) {
                    ...
                    -1 !== (g = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) && (a.valign = i.verticalAlign);
            ...
            148: function(t, e, n) {
                ...
                function i(t, e, n, i, a, s) {
                    ...
                    if (u.length > 0 && (a || "none" !== g.display))
                        return u
                }
                function l(t) {
                    var e = t.cloneNode(!0);
            ...
            587: function(t, e, n) {
                ...
                e.parseInput = function(t, e) {
                    ...
                    var f = function(t, e, n) {
                      ...
                      , p = function(t, e) {
                        var n, o, r, l, a, s, u, d, h, c, f, g, p, y = (0,
                ...
                e.default = function(t, e, o, r) {
                    for (var i = function(e) {
                        ...
                        [["showFoot", "showFooter"], ["showHead", "showHeader"], ["didDrawPage", "addPageContent"], ["didParseCell", "createdCell"], ["headStyles", "headerStyles"]].forEach((function(t) {
                            var n = t[0]
                              , o = t[1];
                            e[o] && (console.error("Use of deprecated option ".concat(o, ". Use ").concat(n, " instead")),
                            e[n] = e[o])
                        }
                        )),
            ...
            49: function(t, e, n) {
                ...
                function h(t, e, n, o, r, l, s) {
                    ...
                    if (n.canEntireRowFit(u, s))
                        ...
                        var a = e.getMinimumRowHeight(o.columns, t)
                          , s = a < n;
                        if (a > l)
                            return console.error("Will not be able to print row ".concat(e.index, " correctly since it's minimum height is larger than page height")),
                            !0;
                        if (!s)
                            return !1;
                        var u = e.hasRowSpan(o.columns);
                        return e.getMaxCellHeight(o.columns) > l ? (u && console.error("The content of row ".concat(e.index, " will not be drawn correctly since drawing rows with a height larger than the page height and has cells with rowspans is not supported.")),
                ...
                e.drawTable = function(t, e) {
                    ...
                    ("always" === n.pageBreak || null != n.startY && f > y.pageSize().height) && (p(y),
                    s.y = i.top);
                    var v = (0,
                    a.assign)({}, s);
                    ...
                    !0 === n.horizontalPageBreak ? function(t, e, n, o) {
                        u.default.calculateAllColumnsCanFitInPage(t, e).map((function(r, i) {
                            t.applyStyles(t.userStyles),
                            i > 0 ? g(t, e, n, o, r.columns) : function(t, e, n, o) {
                                var r = e.settings;
                                t.applyStyles(t.userStyles),
            ...
            189: function(t, e, n) {
                ...
                e.calculateWidths = function(t, e) {
                    ...
                    console.error("Of the table content, ".concat(s, " units width could not fit page"))),
                    function(t) {
                            ...
                            for (var i = r[o], a = 0, s = t.columns; a < s.length; a++) {
                                ...
                                if (d) {
                                    ...
                                    if ("linebreak" === d.styles.overflow)
                                        d.text = e.splitTextToSize(d.text, h + 1 / e.scaleFactor(), {
